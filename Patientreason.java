public class PatReason extends javax.swing.JFrame {

    /**
     * Creates new form PatReason
     */
    public PatReason() {
        initComponents();
    }
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        new PatList(Pname,reason).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatReason.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
